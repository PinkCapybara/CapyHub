...
const Sidebar = ({ user }) => {
  ...
  return (
    <aside className="w-64 h-screen pt-14 transition-transform border-r bg-gray-800 border-gray-700">
      {/* Logo Section */}
      <div className="flex h-20 items-center border-b px-6 border-gray-700">
        <div className="flex items-center gap-3">
          ...
          <span className="text-3xl font-semibold text-white">CapyHub</span>
        </div>
      </div>
        ...
        <ul className="space-y-2">
          ...
          <li>
            <button
              ...
              className="flex items-center w-full p-2 font-medium text-gray-900 rounded-lg text-white hover:bg-gray-700 group"
            >
              <svg
          ...
          <li>
            <button
              ...
              className="flex items-center w-full p-2 text-base font-medium rounded-lg text-white hover:bg-gray-700 group"
            >
              <svg
                className="w-6 h-6 transition duration-75 text-gray-400 group-hover:text-white"
                fill="none"
          ...
          <li>
            ...
            >
              ...
              >
                <path
                  d="M17 17H7C4.51 17 2.5 14.99 2.5 12.5C2.5 10.01 4.51 8 7 8H17C19.49 8 21.5 10.01 21.5 12.5C21.5 14.99 19.49 17 17 17Z"
                  strokeMiterlimit="10"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M7.42737 15C8.80808 15 9.92737 13.8807 9.92737 12.5C9.92737 11.1193 8.80808 10 7.42737 10C6.04666 10 4.92737 11.1193 4.92737 12.5C4.92737 13.8807 6.04666 15 7.42737 15Z"
                  strokeMiterlimit="10"
                />
              </svg>
              ...
              <ul className="py-2 space-y-2">
                <li>
                  <button
                    ...
                    className="flex items-center p-2 pl-11 w-full rounded-lg text-white hover:bg-gray-700"
                  >
                    Push Button
                  </button>
                </li>
          ...
          <li>
            <button
              type="button"
              onClick={() =>
                window.open("https://github.com/PinkCapybara/CapyHub", "_blank")
              }
              className="flex items-center w-full p-2 text-base font-medium rounded-lg transition duration-75 group text-white hover:bg-gray-700"
            >
              <svg
                className="w-6 h-6 transition duration-75 text-gray-400 group-hover:text-white"
                fill="currentColor"
      ...
      {/* Logout Button & Profile Section */}
      <div className="absolute bottom-0 left-0 w-64 p-4 bg-gray-800">
        {/* Logout Button */}
        <button
          onClick={handleLogout}
          className="flex items-center w-full p-2 mb-2 text-base font-medium rounded-lg transition duration-75 group text-white hover:bg-gray-700"
        >
          <svg
            className="w-6 h-6 transition duration-75 text-gray-400 group-hover:text-white"
            fill="none"
